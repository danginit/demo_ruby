...
class DemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demo" do
    assert_difference('Demo.count') do
      post demos_url, params: { demo: { address: @demo.address, email: @demo.email, fname: @demo.fname, lname: @demo.lname, mobile: @demo.mobile } }
    end
  ...
  test "should update demo" do
    patch demo_url(@demo), params: { demo: { address: @demo.address, email: @demo.email, fname: @demo.fname, lname: @demo.lname, mobile: @demo.mobile } }
